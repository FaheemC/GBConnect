    ...
    case 'T127';
        switch($_SESSION['sem']) {
            case '1';
                ...
                $course[4] = 'MATH1071';
                $course[5] = 'COMM1007';
                $book[0] = 'IT Essentials Companion Guide V6 Cisco Networking Academy';
                $book[1] = 'Cisco CCNA Routing and Switching 200-120 Official Cert Guide Library, Academic Edition';
            ...
            case '5';
                ...
                $book[1] = '';
                $book[2] = 'CompTIA Security + SYS-401 in Depth by Mark Ciampa, 2nd Edition (Oct 2014)';
    ...
    case 'T163';
        switch($_SESSION['sem']) {
            ...
            case '3';
                ...
                $book[3] = '';
                $book[4] = 'Agile Game Development with Scrum By Clinton Keith';
            ...
            case '4';
                ...
                $course[5] = 'COMP2148';
                $book[0] = '';
                $book[1] = 'SFML Game Development By: Haller, Hansson & Moreira';
            ...
            case '5';
                ...
                $course[5] = 'GAME3121';
                $book[0] = '';
                $book[1] = '1- Java: A Beginner\'s Guide, 6th edition By: Herbert Schildt';
                ...
                $book[5] = 'Game Coding Complete, Fourth Edition By: Mike McShaffry & David Graham';
                break;
            case '6';
                $course[0] = 'DESN3012';
                $course[1] = 'GAME3004';
                ...
                $course[5] = 'GAME3112';
                $book[0] = '';
                $book[1] = 'Game Development with Swift By: Stephen Haney';
                $book[2] = '';
                $book[3] = 'Game Coding Complete, Fourth Edition By: Mike McShaffry; David Graham';
                $book[4] = 'Programming a Multiplayer FPS in DirectX By: Vaughan Young';
                $book[5] = 'C# 5.0 Pocket Reference By: Joseph Albahari';
                break;
        }
        break;
}
